...
/// <reference path="../scenes/budHouse.ts" />
/// <reference path="../scenes/mansion.ts" />
/// <reference path="../scenes/monopoly.ts" />
/// <reference path="../scenes/ouija.ts" />
/// <reference path="../scenes/basement.ts" />
/// <reference path="../scenes/kitchen.ts" />
/// <reference path="../scenes/murderer.ts" />
