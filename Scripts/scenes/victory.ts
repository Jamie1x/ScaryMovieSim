...
module scenes {
    export class Victory extends objects.Scene {
        ...
        public start() : void {
            ...
            this._gameLabel = new createjs.Bitmap(assets.getResult("Victory"));
            this.addChild(this._gameLabel);

            // Create button for scene and add to Game Scene container. Register for onclick event
            this._menuButton = new objects.Button("Victory-Doomsday", config.Screen.CENTER_X, config.Screen.CENTER_Y + 115);
